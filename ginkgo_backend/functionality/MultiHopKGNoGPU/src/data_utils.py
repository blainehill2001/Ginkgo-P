...
def load_triples(data_path, entity_index_path, relation_index_path, group_examples_by_query=False,
                 add_reverse_relations=False, seen_entities=None, verbose=False, run_single_pred_e1=None, run_single_pred_r=None):
    """
    ...
    if run_single_pred_e1 and run_single_pred_r:
        #print("One triple inference running.")
        return [triple2ids(run_single_pred_e1, 'NO_OP_ENTITY', run_single_pred_r)]
    triples = []
    ...
    for line in set(raw_kb_triples + keep_triples):
        ...
        if not triple_signature in removed_triples:
            ...
            if e2_id in adj_list[e1_id][r_id]:
                pass
                #print('Duplicate fact: {} ({}, {}, {})!'.format(line.strip(), id2entity[e1_id], id2relation[r_id], id2entity[e2_id]))
            ...
            if add_reverse_relations:
                ...
                if e1_id in adj_list[e2_id][inv_r_id]:
                    pass
                    #print('Duplicate fact: {} ({}, {}, {})!'.format(line.strip(), id2entity[e2_id], id2relation[inv_r_id], id2entity[e1_id]))
